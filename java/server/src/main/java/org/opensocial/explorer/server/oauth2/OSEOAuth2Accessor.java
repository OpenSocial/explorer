 ...
 */
public class OSEOAuth2Accessor implements OAuth2Accessor {
  ...
  public OSEOAuth2Accessor() {
    this(null, null, null, null, false, null, null, null, null);
  }

  OSEOAuth2Accessor(final Throwable exception, final OAuth2Error error,
  ...
  public OSEOAuth2Accessor(final OAuth2Accessor accessor) {
  ...
  public OSEOAuth2Accessor(final String gadgetUri, final String serviceName, final String user,
          final String scope, final boolean allowModuleOverrides, final IOAuth2Store store,
